...
class alignas(VL_CACHE_LINE_BYTES) VNV_nvdla_NV_NVDLA_PDP_RDMA_ro_fifo final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgRegularize_h9fae1185_0_2;
    ...
    // CONSTRUCTORS
    VNV_nvdla_NV_NVDLA_PDP_RDMA_ro_fifo(VNV_nvdla__Syms* symsp, const char* v__name);
