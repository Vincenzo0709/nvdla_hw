...
class alignas(VL_CACHE_LINE_BYTES) VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __VdfgRegularize_h0fb462f0_0_1;
    CData/*0:0*/ __VdfgRegularize_h0fb462f0_0_3;
    ...
    // CONSTRUCTORS
    VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo(VNV_nvdla__Syms* symsp, const char* v__name);
