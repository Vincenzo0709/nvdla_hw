...
class alignas(VL_CACHE_LINE_BYTES) VNV_nvdla_NV_NVDLA_SDP_REG_dual final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VNV_nvdla_NV_NVDLA_SDP_REG_dual(VNV_nvdla__Syms* symsp, const char* v__name);
