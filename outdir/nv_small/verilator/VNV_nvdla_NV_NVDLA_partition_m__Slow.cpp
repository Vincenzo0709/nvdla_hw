...
VNV_nvdla_NV_NVDLA_partition_m::VNV_nvdla_NV_NVDLA_partition_m(VNV_nvdla__Syms* symsp, const char* v__name)
...
void VNV_nvdla_NV_NVDLA_partition_m::__Vconfigure(bool first) {
