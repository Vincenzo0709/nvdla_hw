...
class alignas(VL_CACHE_LINE_BYTES) VNV_nvdla_NV_NVDLA_CDMA_dual_reg final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VNV_nvdla_NV_NVDLA_CDMA_dual_reg(VNV_nvdla__Syms* symsp, const char* v__name);
