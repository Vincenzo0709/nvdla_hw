...
VL_ATTR_COLD void VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo___ctor_var_reset(VNV_nvdla_NV_NVDLA_NOCIF_DRAM_READ_EG_ro_fifo* vlSelf) {
    ...
    vlSelf->__PVT__prand_inst2__Vstatic__diff = VL_RAND_RESET_Q(33);
    vlSelf->__PVT__prand_inst3__Vstatic__diff = VL_RAND_RESET_Q(33);
    vlSelf->__VdfgRegularize_h0fb462f0_0_1 = VL_RAND_RESET_I(1);
    vlSelf->__VdfgRegularize_h0fb462f0_0_3 = VL_RAND_RESET_I(1);
